...
install_S21deps() {
    ...
    case $mgr in
        pacman) yay -S brightnessctl flameshot waybar waypaper swaybg pywal wl-paste wl-clipboard swaylock fish kitty rofi wlogout pipewire-pulse batsignal polkit-gnome starship swayidle swaync syscgo nmtui bluetui ;;
        xbps) sudo xbps-install -y brightnessctl flameshot waybar waypaper swaybg pywal wl-paste wl-clipboard swaylock fish kitty rofi wlogout pipewire-pulse batsignal polkit-gnome starship swayidle swaync nmtui bluetui ; curl -fsSL https://raw.githubusercontent.com/Nomadcxx/sysc-Go/master/install.sh | sudo bash ;;
        dnf) sudo dnf install -y brightnessctl flameshot waybar waypaper swaybg pywal wl-paste wl-clipboard swaylock fish kitty rofi wlogout pipewire-pulse batsignal polkit-gnome starship swayidle swaync nmtui bluetui ; curl -fsSL https://raw.githubusercontent.com/Nomadcxx/sysc-Go/master/install.sh | sudo bash ;;
        zypper) sudo zypper install -y brightnessctl flameshot waybar waypaper swaybg pywal wl-paste wl-clipboard swaylock fish kitty rofi wlogout pipewire-pulse batsignal polkit-gnome starship swayidle swaync nmtui bluetui ; curl -fsSL https://raw.githubusercontent.com/Nomadcxx/sysc-Go/master/install.sh | sudo bash ;;
        apt) sudo apt update && sudo apt install -y brightnessctl flameshot waybar waypaper swaybg pywal wl-paste wl-clipboard swaylock fish kitty rofi wlogout pipewire-pulse batsignal polkit-gnome starship swayidle swaync nmtui bluetui ; curl -fsSL https://raw.githubusercontent.com/Nomadcxx/sysc-Go/master/install.sh | sudo bash ;;
